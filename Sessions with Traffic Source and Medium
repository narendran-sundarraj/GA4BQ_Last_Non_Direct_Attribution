with events as (
   select
    ...
    event_timestamp
  from
    `steam-mantis-108908.analytics_216367908.events_*` -- Replace with your actual source table name.
  where
    (_table_suffix >= '20241201' and _table_suffix <= '20241231') -- Replace with your desired date range.
